...
import com.dji.sdk.sample.demo.flightcontroller.FlightControlActivity2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button flightControlButton2 = findViewById(R.id.button_flight_control2);
        flightControlButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FlightControlActivity2.class);
